...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2025 a las 01:03:30
...
--
ALTER TABLE `user_specialty`
  ADD CONSTRAINT `user_specialty_ibfk_1` FOREIGN KEY (`id_user_specialty`) REFERENCES `users` (`id_user`) ON DELETE CASCADE;
COMMIT;
